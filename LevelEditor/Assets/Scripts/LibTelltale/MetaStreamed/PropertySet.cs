...
namespace LibTelltale
{
	...
	public static class KeyTypes
	{
		...
		public static readonly KeyTypeHandle<LocationInfo> TYPE_LOCATION_INFO = new KeyTypeHandle<LocationInfo>("locationinfo", (x, old) =>
		{
			...
			Marshal.WriteInt32(x.reference, 16, SingleToInt32Bits(x.mRotation.x));
			Marshal.WriteInt32(x.reference, 20, SingleToInt32Bits(x.mRotation.y));
			Marshal.WriteInt32(x.reference, 24, SingleToInt32Bits(x.mRotation.z));
			Marshal.WriteInt32(x.reference, 28, SingleToInt32Bits(x.mScale));
			Marshal.WriteInt32(x.reference, 32, SingleToInt32Bits(x.mPosition.x));
			Marshal.WriteInt32(x.reference, 36, SingleToInt32Bits(x.mPosition.y));
			Marshal.WriteInt32(x.reference, 40, SingleToInt32Bits(x.mPosition.z));
			return x.reference;
		}, x =>
		{
			...
			inf.mRotation.x = Int32BitsToSingle(Marshal.ReadInt32(x, 16));
			inf.mRotation.y = Int32BitsToSingle(Marshal.ReadInt32(x, 20));
			inf.mRotation.z = Int32BitsToSingle(Marshal.ReadInt32(x, 24));
			inf.mScale =	  Int32BitsToSingle(Marshal.ReadInt32(x, 28));
			inf.mPosition.x = Int32BitsToSingle(Marshal.ReadInt32(x, 32));
			inf.mPosition.y = Int32BitsToSingle(Marshal.ReadInt32(x, 36));
			inf.mPosition.z = Int32BitsToSingle(Marshal.ReadInt32(x, 40));
			return inf;
		});
		...
		public static readonly KeyTypeHandle<PhonemeKey> TYPE_PHONEME_KEY = new KeyTypeHandle<PhonemeKey>("phonemekey", (key, old) =>
		{
			...
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(key.mFadeInTime));
			Marshal.WriteInt32(a(ptr, 12), SingleToInt32Bits(key.mHoldTime));
			Marshal.WriteInt32(a(ptr, 16), SingleToInt32Bits(key.mFadeOutTime));
			Marshal.WriteInt32(a(ptr, 20), SingleToInt32Bits(key.mTargetContribution));
			return ptr;
		}, ptr =>
		{
			PhonemeKey ret = new PhonemeKey();
			ret.mPhoneme = new Handle(Marshal.ReadIntPtr(ptr));
			ret.mFadeInTime = Int32BitsToSingle(Marshal.ReadInt32(a(ptr, 8)));
			ret.mHoldTime= Int32BitsToSingle(Marshal.ReadInt32(a(ptr, 12)));
			ret.mFadeOutTime = Int32BitsToSingle(Marshal.ReadInt32(a(ptr, 16)));
			ret.mTargetContribution = Int32BitsToSingle(Marshal.ReadInt32(a(ptr, 20)));
			return ret;
		});
			...
			KeyTypeHandle<T3MaterialEnlightenPrecomputeParams>("t3materialenlightenprecomputeparams", (x, old) =>
		{
			...
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.mPrecomputeVisiblity));
			Marshal.WriteInt32(a(ptr,4), x.unknown);
			return ptr;
		}, x =>
		{
			T3MaterialEnlightenPrecomputeParams ret = new T3MaterialEnlightenPrecomputeParams();
			ret.mPrecomputeVisiblity = Int32BitsToSingle(Marshal.ReadInt32(x));
		...
		public static readonly KeyTypeHandle<ProceduralLookAtConstraint> TYPE_PROCEDURAL_LOOKAT_CONSTRAINT = new KeyTypeHandle<ProceduralLookAtConstraint>("procedural_lookat::constraint", (x, old) =>
		{
			...
			IntPtr ptr = old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.minA));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.maxA));
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(x.valueB));
			Marshal.WriteInt32(a(ptr, 12), SingleToInt32Bits(x.valueC));
		...
		}, x =>
		{
			...
			ret.minA = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.maxA = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			ret.valueB = Int32BitsToSingle(Marshal.ReadInt32(a(x, 8)));
			ret.valueC = Int32BitsToSingle(Marshal.ReadInt32(a(x, 12)));
		...
		{
			IntPtr ptr = e(old) ? alloc(4) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x));
			return ptr;
		}, x =>
		{
			return Int32BitsToSingle(Marshal.ReadInt32(x));
		});

		public static readonly KeyTypeHandle<Polar> TYPE_POLAR = new KeyTypeHandle<Polar>("polar", (x, old) =>
		{
			IntPtr ptr = e(old) ? alloc(12) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.mR));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.mTheta));
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(x.mPhi));
			return ptr;
		}, x =>
		{
			Polar ret = new Polar();
			ret.mR = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.mTheta = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			ret.mPhi = Int32BitsToSingle(Marshal.ReadInt32(a(x, 8)));
			return ret;
		});
		...
		{
			IntPtr ptr = e(old) ? alloc(16) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.a));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.r));
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(x.g));
			Marshal.WriteInt32(a(ptr, 12), SingleToInt32Bits(x.b));
			return ptr;
		}, x =>
		{
			Colour ret = new Colour();
			ret.a = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.r = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			ret.g = Int32BitsToSingle(Marshal.ReadInt32(a(x, 8)));
			ret.b = Int32BitsToSingle(Marshal.ReadInt32(a(x, 12)));
			return ret;
		});
		...
		{
			IntPtr ptr = e(old) ? alloc(16) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.x));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.y));
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(x.z));
			Marshal.WriteInt32(a(ptr, 12), SingleToInt32Bits(x.w));
			return ptr;
		}, x =>
		{
			Quaternion ret = new Quaternion();
			ret.x = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.y = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			ret.z = Int32BitsToSingle(Marshal.ReadInt32(a(x, 8)));
			ret.w = Int32BitsToSingle(Marshal.ReadInt32(a(x, 12)));
			return ret;
		});
		...
		public static readonly KeyTypeHandle<ParticleLODKey> TYPE_PARTICLE_LOD_KEY = new KeyTypeHandle<ParticleLODKey>("particlelodkey", (x, old) =>
		{
			IntPtr ptr = e(old) ? alloc(16) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.a));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.b));
			Marshal.WriteInt32(a(ptr, 8), SingleToInt32Bits(x.c));
			Marshal.WriteInt32(a(ptr, 12), SingleToInt32Bits(x.d));
			return ptr;
		}, x =>
		{
			ParticleLODKey ret = new ParticleLODKey();
			ret.a = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.b = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			ret.c = Int32BitsToSingle(Marshal.ReadInt32(a(x, 8)));
			ret.d = Int32BitsToSingle(Marshal.ReadInt32(a(x, 12)));
			return ret;
		});
		...
		{
			IntPtr ptr = e(old) ? alloc(8) : old;
			Marshal.WriteInt32(ptr, SingleToInt32Bits(x.min));
			Marshal.WriteInt32(a(ptr, 4), SingleToInt32Bits(x.max));
			return ptr;
		}, x =>
		{
			TRangeFloat ret = new TRangeFloat();
			ret.min = Int32BitsToSingle(Marshal.ReadInt32(x));
			ret.max = Int32BitsToSingle(Marshal.ReadInt32(a(x, 4)));
			return ret;
		});
